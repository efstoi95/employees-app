...
public interface EmployeesRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("SELECT e FROM Employee e JOIN e.projects p")
    List<Employee> findEmployeesInProjects();

    @Query("SELECT e FROM Employee e JOIN e.tasks t")
    List<Employee> findEmployeesInTasks();
}
